        ...
        if (innerWidth < 1024) {
            ...
            for (const audioId in allSpriteHdLinks) {
                if (Object.prototype.hasOwnProperty.call(allSpriteHdLinks, audioId)) {
                    global.allSprites[audioId] = yield fetchBlob(allSpriteHdLinks[audioId]);
                }
            }
        }
    });
